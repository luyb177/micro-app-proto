...
const (
	...
	ErrorReason_Invalid_ID     ErrorReason = 1
)
...
const file_api_user_v1_error_reason_proto_rawDesc = "" +
	"\n" +
	"\x1eapi/user/v1/error_reason.proto\x12\auser.v1*1\n" +
	"\vErrorReason\x12\x12\n" +
	"\x0eUSER_NOT_FOUND\x10\x00\x12\x0e\n" +
	"\n" +
	"Invalid_ID\x10\x01B\x10Z\x0eapi/user/v1;v1b\x06proto3"
