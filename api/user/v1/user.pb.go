...
var file_api_user_v1_user_proto_goTypes = []any{
	...
	(*BuGoosRequest)(nil),    // 8: user.v1.BuGoosRequest
	(*BuGoosReply)(nil),      // 9: user.v1.BuGoosReply
}
var file_api_user_v1_user_proto_depIdxs = []int32{
	...
	8, // 6: user.v1.Users.BuyGoods:input_type -> user.v1.BuGoosRequest
	...
	5, // 9: user.v1.Users.IncrMoney:output_type -> user.v1.IncrMoneyReply
	7, // 10: user.v1.Users.GetUser:output_type -> user.v1.GetUserReply
	9, // 11: user.v1.Users.BuyGoods:output_type -> user.v1.BuGoosReply
